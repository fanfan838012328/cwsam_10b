...
class Block(nn.Module):
    ...
    def __init__(
        ...
        # self.MLP_Adapter1 = Adapter(dim, skip_connect=False)  # First MLP-adapter
        # self.MLP_Adapter2 = Adapter(dim, skip_connect=False)  # Second MLP-adapter
        # self.Space_Adapter1 = Adapter(dim)  # First Space-adapter
        # self.Space_Adapter2 = Adapter(dim)  # Second Space-adapter
        # self.scale = scale
        # self.Depth_Adapter1 = Adapter(dim, skip_connect=False)  # First Depth-adapter
        # self.Depth_Adapter2 = Adapter(dim, skip_connect=False)  # Second Depth-adapter
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        # Apply doubled Space adapters sequentially
        # x = self.Space_Adapter1(x)
        # x = self.Space_Adapter2(x)
        ...
        # Apply doubled MLP adapters
        # x = x + self.mlp(xn) + self.scale * (self.MLP_Adapter1(xn) + self.MLP_Adapter2(xn))
